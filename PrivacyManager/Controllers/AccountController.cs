...
namespace PrivacyManager.Controllers
{
    ...
    {
        private PrivacyManagerSignInManager _signInManager;
        private PrivacyManagerUserManager _userManager;

        public AccountController()
        {
        }

        public AccountController(PrivacyManagerUserManager userManager, PrivacyManagerSignInManager signInManager )
        {
            UserManager = userManager;
            SignInManager = signInManager;
        }

        public PrivacyManagerSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<PrivacyManagerSignInManager>();
            }
            private set 
            { 
        ...
        public PrivacyManagerUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<PrivacyManagerUserManager>();
            }
            private set
            {
                _userManager = value;
...
//**********************************************************************************//
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new PrivacyManagerUser { UserName = model.Username, Email = model.Email, RegisteredOn = DateTime.Now};
